...
This repository demonstrates a structured Active Directory (AD) and Windows Server lab environment designed to simulate real-world enterprise IT infrastructure. It showcases practical skills in system administration, network configuration, identity management, security monitoring, and Windows Server administration.

The project is organized into modular folders representing key ICT infrastructure and security domains.
...
This project showcases enterprise endpoint security, encryption management, Group Policy administration, and Active Directory integration for centralized recovery key management.
